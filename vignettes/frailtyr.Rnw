...
$\omega\sim\Gamma(\frac{1}{\theta},\frac{1}{\theta})$,
...
{\theta^{\frac{1}{\theta}}\Gamma(\frac{1}{\theta})}
...
\frac{\left(\frac{\omega}{\theta}\right)^{\frac{1}{\theta}-1}
\exp\left(\frac{-\omega}{\theta}\right)
\left\{ \ln\left(\frac{\theta}{\omega}\right)+\psi^{(0)}\left(\frac{1}{\theta}\right)+\omega-1\right\} }
{\theta^{3}\Gamma\left(\frac{1}{\theta}\right)}
...
\exp\left\{ \frac{-\left(\ln\omega\right)^{2}}{2\theta}\right\} 
...
\begin{equation}
\frac{\partial LN(\omega;\theta)}{\partial\theta}=\frac{\ln^{2}\left(\omega\right)\exp\left\{ \frac{-\ln^{2}\omega}{2\theta}\right\} }{2\sqrt{2\pi}\theta^{5/2}\omega}-\frac{\exp\left\{ \frac{-\ln^{2}\omega}{2\theta}\right\} }{2\sqrt{2\pi}\theta^{3/2}\omega}
...
\begin{equation}
\left\{ 2\pi\left(1-\alpha\right)\right\} ^{1/2}\delta^{1/\left\{ 2\left(1-\alpha\right)\right\} }\omega^{\mathit{v}}\exp\left\{ -\theta\omega-\delta^{1/\left(1-\alpha\right)}\left(\frac{1}{\alpha}-1\right)\omega^{-\alpha/\left(1-\alpha\right)}+\frac{\delta\theta^{\alpha}}{\alpha}\right\}
...
\begin{equation}
PVF\left(\omega;\alpha\right)=\exp\left\{ -\omega+\alpha^{-1}\right\} \frac{1}{\pi}\sum_{k=1}^{\infty}\frac{\Gamma\left(k\alpha+1\right)}{k!}\left(-\frac{1}{\omega}\right)^{\alpha k+1}\sin\left(\alpha k\pi\right)
