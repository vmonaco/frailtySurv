...
\begin{equation}
f(\omega;\theta)=\frac{1}{\omega\sqrt{\theta2\pi}}\exp\left\{ \frac{-\left(\ln\omega\right)^{2}}{2\theta}\right\} \label{eq:density-log-norm}
\end{equation}
...
\begin{equation}
\left\{ 2\pi\left(1-\alpha\right)\right\} ^{1/2}\delta^{1/\left\{ 2\left(1-\alpha\right)\right\} }\omega^{\mathit{v}}\exp\left\{ -\theta\omega-\delta^{1/\left(1-\alpha\right)}\left(\frac{1}{\alpha}-1\right)\omega^{-\alpha/\left(1-\alpha\right)}+\frac{\delta\theta^{\alpha}}{\alpha}\right\} \label{eq:pvf-saddle-point-approx}
\end{equation}
