...
// U_r
double U_r(Rcpp::List R_, Rcpp::List N_dot, Rcpp::List I_, Rcpp::List X_, Rcpp::List H_, Rcpp::List H_dot, NumericVector beta, NumericVector theta, int beta_idx, String frailty);
RcppExport SEXP frailtyr_U_r(SEXP R_SEXP, SEXP N_dotSEXP, SEXP I_SEXP, SEXP X_SEXP, SEXP H_SEXP, SEXP H_dotSEXP, SEXP betaSEXP, SEXP thetaSEXP, SEXP beta_idxSEXP, SEXP frailtySEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< String >::type frailty(frailtySEXP);
    __result = Rcpp::wrap(U_r(R_, N_dot, I_, X_, H_, H_dot, beta, theta, beta_idx, frailty));
    return __result;
END_RCPP
}
// U_p
double U_p(Rcpp::List R_, Rcpp::List N_dot, Rcpp::List I_, Rcpp::List X_, Rcpp::List H_, Rcpp::List H_dot, NumericVector beta, NumericVector theta, int theta_idx, String frailty);
RcppExport SEXP frailtyr_U_p(SEXP R_SEXP, SEXP N_dotSEXP, SEXP I_SEXP, SEXP X_SEXP, SEXP H_SEXP, SEXP H_dotSEXP, SEXP betaSEXP, SEXP thetaSEXP, SEXP theta_idxSEXP, SEXP frailtySEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< Rcpp::List >::type R_(R_SEXP);
    ...
    Rcpp::traits::input_parameter< String >::type frailty(frailtySEXP);
    __result = Rcpp::wrap(U_p(R_, N_dot, I_, X_, H_, H_dot, beta, theta, theta_idx, frailty));
    return __result;
END_RCPP
}
// log_likelihood
double log_likelihood(NumericVector beta, NumericVector theta, NumericVector lambda, List H_dot, List I_, List R_, List X_, List N_dot, String frailty);
RcppExport SEXP frailtyr_log_likelihood(SEXP betaSEXP, SEXP thetaSEXP, SEXP lambdaSEXP, SEXP H_dotSEXP, SEXP I_SEXP, SEXP R_SEXP, SEXP X_SEXP, SEXP N_dotSEXP, SEXP frailtySEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type beta(betaSEXP);
    ...
    Rcpp::traits::input_parameter< String >::type frailty(frailtySEXP);
    __result = Rcpp::wrap(log_likelihood(beta, theta, lambda, H_dot, I_, R_, X_, N_dot, frailty));
    return __result;
END_RCPP
}
